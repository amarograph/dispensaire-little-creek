...
const T = { bg: '#1A1208', card: '#1F1610', paper: '#221408', border: 'rgba(139,90,43,0.30)', gold: '#C8A850', text: '#E8D9C0', muted: '#8B7355', dim: '#5A4A35', sepia: '#D4B896' };
...
const btnGold: React.CSSProperties = { ...btn, border: `1px solid ${T.gold}`, color: T.gold, background: 'rgba(200,168,80,0.08)' };
...
const REGLEMENT_CHAPITRES = [
  ...
  { num: 'II',   title: "DE L'ORGANISATION DU DISPENSAIRE",    icon: '⚙',  col: '#486878' },
  { num: 'III',  title: "DE L'HYGIÈNE ET DE LA SALUBRITÉ",     icon: '🧼', col: '#5A7848' },
  ...
  { num: 'VII',  title: "DE L'ENSEIGNEMENT MÉDICAL",            icon: '📖', col: '#4A6048' },
  { num: 'VIII', title: 'DU SECRET MÉDICAL',                    icon: '🔒', col: '#705030' },
  { num: 'IX',   title: 'DE LA MORALITÉ DU PRATICIEN',          icon: '⚖',  col: '#C8A850' },
  { num: 'X',    title: 'DES SANCTIONS DISCIPLINAIRES',         icon: '⚠',  col: '#A82020' },
] as const;
...
function RegCitation({ text, author }: { text: string; author: string }) {
  return (
    <div style={{ margin: '18px 0 0', padding: '16px 24px', borderLeft: `3px solid ${T.gold}`, background: 'rgba(200,168,80,0.06)', position: 'relative' }}>
    ...
    <div style={{ marginTop: 50 }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: 36, padding: '36px 20px', background: T.card, border: `1px solid ${T.border}`, position: 'relative', overflow: 'hidden' }}>
        {['top-left', 'top-right', 'bottom-left', 'bottom-right'].map(pos => (
          <div key={pos} style={{ position: 'absolute', top: pos.includes('top') ? 12 : 'auto', bottom: pos.includes('bottom') ? 12 : 'auto', left: pos.includes('left') ? 12 : 'auto', right: pos.includes('right') ? 12 : 'auto', width: 28, height: 28, borderTop: pos.includes('top') ? '2px solid rgba(200,168,80,0.45)' : 'none', borderBottom: pos.includes('bottom') ? '2px solid rgba(200,168,80,0.45)' : 'none', borderLeft: pos.includes('left') ? '2px solid rgba(200,168,80,0.45)' : 'none', borderRight: pos.includes('right') ? '2px solid rgba(200,168,80,0.45)' : 'none' }} />
        ))}
      ...
      {/* Sommaire */}
      <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap', marginBottom: 36, padding: '14px 18px', background: 'rgba(200,168,80,0.04)', border: `1px solid rgba(200,168,80,0.18)` }}>
      ...
      <div style={{ marginBottom: 36 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20 }}>
          <div style={{ fontFamily: DISPLAY, fontSize: 14, color: T.gold, letterSpacing: '0.22em', background: 'rgba(200,168,80,0.10)', padding: '6px 16px', border: `1px solid rgba(200,168,80,0.30)` }}>PRÉAMBULE</div>
      ...
      <div id="chap-I" style={{ marginBottom: 36, background: T.paper, border: `1px solid ${REGLEMENT_CHAPITRES[0].col}40`, borderTop: `3px solid ${REGLEMENT_CHAPITRES[0].col}`, padding: '28px 32px' }}>
        ...
        <div style={{ background: 'rgba(139,64,64,0.10)', border: '1px solid rgba(139,64,64,0.30)', padding: '14px 20px' }}>
          <div style={{ fontFamily: MONO, fontSize: 12, color: '#C06060', letterSpacing: '0.14em', marginBottom: 6 }}>⚠ AVERTISSEMENT</div>
          <RegPara>L'état d'ivresse, l'usage abusif de substances altérant le jugement ou toute négligence mettant en danger un patient pourront entraîner des <strong style={{ color: '#C06060' }}>sanctions immédiates</strong>.</RegPara>
        </div>
      </div>
      ...
      <div id="chap-V" style={{ marginBottom: 36, background: T.paper, border: `1px solid ${REGLEMENT_CHAPITRES[4].col}40`, borderTop: `3px solid ${REGLEMENT_CHAPITRES[4].col}`, padding: '28px 32px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, margin: '24px 0 14px' }}>
          ...
          <div style={{ flex: 1, height: '1px', background: 'rgba(200,168,80,0.18)' }} />
        </div>
      ...
      <div style={{ textAlign: 'center', padding: '8px 0 0' }}>
        ...
        <div style={{ fontFamily: MONO, fontSize: 11, color: T.dim, letterSpacing: '0.16em', marginBottom: 22 }}>DIRECTEUR DU DISPENSAIRE DE WEST ELIZABETH</div>
...
const HERBORISTE_CHAPITRES = [
  ...
  { num: 'III', title: 'PLANTES CICATRISANTES ET ANTI-INFECTIEUSES',  icon: '🩹', col: '#5A7848' },
  { num: 'IV',  title: 'PLANTES DIGESTIVES ET DÉPURATIVES',           icon: '🌾', col: '#486878' },
  { num: 'V',   title: 'SUBSTANCES DANGEREUSES ET USAGES PROHIBÉS',   icon: '☠',  col: '#A82020' },
] as const;
    ...
    <div style={{ background: T.card, border: `1px solid ${T.border}`, borderLeft: `3px solid ${T.gold}`, padding: '20px 24px', marginBottom: 16 }}>
      ...
      {danger && (
        <div style={{ background: 'rgba(139,64,64,0.10)', border: '1px solid rgba(139,64,64,0.30)', padding: '12px 16px', marginTop: 10 }}>
          <div style={{ fontFamily: MONO, fontSize: 11, color: '#C06060', letterSpacing: '0.14em', marginBottom: 6 }}>⚠ PRÉCAUTION</div>
...
function GuideHerboristeDocument() {
  return (
    <div style={{ marginTop: 50 }}>
      ...
      <div style={{ marginBottom: 36 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20 }}>
          <div style={{ fontFamily: DISPLAY, fontSize: 14, color: T.gold, letterSpacing: '0.22em', background: 'rgba(200,168,80,0.10)', padding: '6px 16px', border: `1px solid rgba(200,168,80,0.30)` }}>AVANT-PROPOS</div>
          <div style={{ flex: 1, height: 1, background: 'rgba(200,168,80,0.25)' }} />
        </div>
        <RegBlock col="rgba(200,168,80,0.35)">
      ...
      <div style={{ textAlign: 'center', padding: '8px 0 0' }}>
        ...
        <div style={{ fontFamily: MONO, fontSize: 11, color: T.dim, letterSpacing: '0.16em', marginBottom: 22 }}>HERBORISTE DU DISPENSAIRE DE WEST ELIZABETH</div>
...
const SPECIALITES_LIST = [
  { titre: 'Médecine Générale',      col: '#5A9A58', desc: 'Le médecin généraliste est le premier praticien consulté par la population. Il diagnostique les maladies courantes, soigne les blessures légères et oriente les patients vers une spécialité lorsque cela est nécessaire.' },
  { titre: 'Chirurgie',              col: '#C83030', desc: 'Le chirurgien intervient lors des blessures graves et des opérations nécessitant une intervention manuelle. Il traite notamment les fractures complexes, les plaies profondes, les amputations et certaines urgences vitales.' },
  ...
  { titre: 'Plantes Médicinales',    col: '#5A7848', desc: 'Le spécialiste des plantes médicinales étudie et prépare les remèdes naturels du dispensaire. Il utilise les propriétés thérapeutiques des plantes pour soulager les douleurs, combattre certaines maladies et favoriser la guérison.' },
  ...
  { titre: 'Hygiène et Santé Publique', col: '#486878', desc: 'Cette spécialité veille à la prévention des maladies et à la protection de la population. Elle surveille les risques sanitaires, les épidémies, la salubrité des lieux publics et les mesures d\'hygiène au sein des dispensaires.' },
...
function SpecialitesDocument() {
  return (
    <div style={{ marginTop: 50 }}>
      ...
      {/* Note du Dispensaire */}
      <div style={{ background: T.card, border: `1px solid rgba(200,168,80,0.35)`, borderLeft: `4px solid ${T.gold}`, padding: '24px 28px' }}>
        <div style={{ fontFamily: DISPLAY, fontSize: 14, color: T.gold, letterSpacing: '0.22em', background: 'rgba(200,168,80,0.10)', padding: '5px 14px', border: `1px solid rgba(200,168,80,0.30)`, display: 'inline-block', marginBottom: 16 }}>NOTE DU DISPENSAIRE</div>
...
const DOCTRINE_ARTICLES = [
  ...
  { num: 'X',    title: "REMÈDES HYGIÉNIQUES DU DISPENSAIRE",             icon: '⚗',  col: '#5A7848' },
        ...
        <div>
          ...
          <div id="doc-art-VIII" style={{ marginBottom: 28, background: T.paper, border: `1px solid ${DOCTRINE_ARTICLES[7].col}40`, borderTop: `3px solid ${DOCTRINE_ARTICLES[7].col}`, padding: '26px 30px' }}>
            ...
            {[
              ...
              { grade: 'Infirmiers',         col: '#5A7848', items: ['Assurent l\'entretien des chambres, la stérilisation du matériel et la préparation des solutions antiseptiques.', 'Enseignent la discipline hygiénique et veillent à la sécurité des soins.'] },
...
const PLANTES = [
  ...
  {
    num: '3', nom: 'Romarin', lat: 'Rosmarinus officinalis', icon: '🌿', col: '#5A7848',
  ...
  return (
    <div style={{ marginTop: 50 }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: 30, padding: '36px 20px', background: T.card, border: `1px solid ${MC}50`, position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ fontFamily: MONO, fontSize: 11, color: T.dim, letterSpacing: '0.12em', marginBottom: 14 }}>DISPENSAIRE DE WEST ELIZABETH · 1890</div>
      ...
      {version === 'resume' && (
        <div>
          ...
          <div style={{ marginBottom: 24, background: T.paper, border: `1px solid ${MC}30`, borderLeft: `3px solid ${MC}`, padding: '18px 22px' }}>
            ...
            {[
              { label: 'Remèdes végétaux', items: ["Teinture Mère d'Échinacée", "Décoction Fébrifuge", "Sirop Pectoral", "Décoction Expectorante", "Macération de Panax", "Vin Quinquiné"], col: '#5A7848' },
          ...
          <div id="inf-ch-III" style={{ marginBottom: 28, background: T.paper, border: `1px solid ${MC}40`, borderTop: `3px solid ${MC}`, padding: '26px 30px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 22 }}>
              {REMEDIES_VEGETAUX.map(r => (
                <div key={r.nom} style={{ background: T.card, border: '1px solid rgba(90,120,72,0.35)', borderLeft: '3px solid #5A7848', padding: '12px 18px', display: 'flex', gap: 20, alignItems: 'flex-start' }}>
...
const CATAPLASMES = [
  {
    id: 'A', nom: 'Cataplasme Purifiant', col: '#5A7848',
...
function MedTable({ rows }: { rows: readonly (readonly string[])[] }) {
  ...
  const tdStyle: React.CSSProperties = { padding: '9px 14px', fontFamily: BODY, fontSize: 14, color: '#C8C8D8', borderBottom: `1px solid ${MMC}20`, verticalAlign: 'top' };
      ...
      {version === 'resume' && (
        <div>
          ...
          <div style={{ marginBottom: 22, background: T.paper, border: `1px solid ${MMC}35`, borderTop: `3px solid ${MMC}`, padding: '22px 26px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 14 }}>
              {[
                { titre: 'Remèdes végétaux',        col: '#5A7848', items: ["Tilleul.", "Saule.", "Camomille.", "Menthe.", "Thym.", "Consoude.", "Millepertuis.", "Valériane.", "Échinacée.", "Panax."] },
                ...
                <div key={cat.titre} style={{ background: T.card, border: `1px solid ${cat.col}40`, borderLeft: `3px solid ${cat.col}`, padding: '12px 16px' }}>
                  <div style={{ fontFamily: DISPLAY, fontSize: 14, color: cat.col === '#5A7848' ? '#8AAA70' : cat.col === '#7A5830' ? '#A07850' : '#9878B8', marginBottom: 8 }}>{cat.titre}</div>
                  <RegList items={cat.items} />
                </div>
              ))}
            </div>
        ...
        <div>
          ...
          {chapterBlock('med-ch-II', <>
            ...
            {subSection('5. Pharmacologie Végétale et Pharmaceutique', <>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 14 }}>
                {[
                  { titre: 'Remèdes végétaux',        col: '#5A7848', colL: '#8AAA70', items: ["Tilleul.", "Saule.", "Camomille.", "Menthe.", "Thym.", "Consoude.", "Millepertuis.", "Valériane.", "Échinacée.", "Panax."] },
...
const AFFECTIONS = [
  ...
  {
    num: 'V', nom: 'Maux de Gorge', col: '#5A7848',
...
const REMEDES_GEN = [
  ...
  { nom: 'Eau Vulnéraire',    col: '#5A7848', usages: ["Nettoyer les plaies.", "Prévenir les infections."] },
...
const CATAPLASMES_AD = [
  ...
  { nom: 'Cataplasme du Soldat',         col: '#5A7848', ingredients: ["Romarin.", "Lavande.", "Prêle."],                          usages: ["Courbatures.", "Douleurs du dos.", "Fatigue musculaire."] },
...
const PREPARATIONS_INT = [
  ...
  { nom: "Infusion du Guerrier Guéri",   col: '#5A7848', ingredients: ["Reine-des-Prés.", "Ortie.", "Romarin."],             usages: ["Convalescence.", "Douleurs résiduelles."] },
    ...
    <div style={{ marginTop: 50 }}>
            ...
            <div key={titre} style={{ marginBottom: 16, background: T.paper, border: `1px solid ${col}30`, borderLeft: `4px solid ${col}`, padding: '14px 20px' }}>
              ...
              {list.map(s => (
                <div key={s.nom} style={{ marginBottom: 4, display: 'flex', gap: 10, alignItems: 'baseline', flexWrap: 'wrap' }}>
                  ...
                  {s.prescription && <span style={{ fontFamily: MONO, fontSize: 10, color: '#C05050', letterSpacing: '0.1em' }}>PRESCRIPTION</span>}
                </div>
              ))}
            </div>
          ))}
          ...
          <div style={{ marginBottom: 16, background: T.paper, border: '1px solid #30406040', borderLeft: '4px solid #304060', padding: '14px 20px' }}>
            ...
            {ANESTHESIQUES_SED.map(a => (
              <div key={a.nom} style={{ marginBottom: 4, display: 'flex', gap: 10, alignItems: 'baseline', flexWrap: 'wrap' }}>
                ...
                <span style={{ fontFamily: MONO, fontSize: 10, color: '#C05050', letterSpacing: '0.1em' }}>PRESCRIPTION</span>
              </div>
            ))}
          </div>
              ...
              <tbody>
                {(ECHELLE_SED as unknown as string[][]).map(row => (
                  <tr key={row[0]}>
                    ...
                    <td style={{ padding: '8px 12px', fontFamily: BODY, fontSize: 13, color: '#C8C8D8', borderBottom: `1px solid ${SC}20` }}>{row[2]}</td>
                    <td style={{ padding: '8px 12px', fontFamily: BODY, fontSize: 13, color: '#C8C8D8', borderBottom: `1px solid ${SC}20` }}>{row[3]}</td>
      ...
      {version === 'complete' && (
        <div>
          ...
          {SEDATIFS_MODERES.map(s => (
            <div key={s.nom} style={{ marginBottom: 14, background: T.paper, border: `1px solid ${s.col}30`, borderLeft: `4px solid ${s.col}` }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 14, padding: '14px 18px 10px', flexWrap: 'wrap' }}>
                <div style={{ fontFamily: DISPLAY, fontSize: 20, color: T.gold }}>{s.nom}</div>
                <div style={{ fontFamily: MONO, fontSize: 11, color: T.dim, letterSpacing: '0.1em' }}>{s.surnom}</div>
                {s.prescription && <span style={{ fontFamily: MONO, fontSize: 10, color: '#C05050', letterSpacing: '0.15em', padding: '3px 8px', border: '1px solid #C0505060', background: 'rgba(192,80,80,0.08)' }}>PRESCRIPTION REQUISE</span>}
              </div>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 0, padding: '0 18px 14px' }}>
                <div>
                  <div style={{ fontFamily: MONO, fontSize: 10, color: SC_LIGHT, letterSpacing: '0.2em', marginBottom: 6 }}>VERTUS</div>
          ...
          {SEDATIFS_FORTS.map(s => (
            <div key={s.nom} style={{ marginBottom: 14, background: T.paper, border: `1px solid ${s.col}30`, borderLeft: `4px solid ${s.col}` }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 14, padding: '14px 18px 10px', flexWrap: 'wrap' }}>
                <div style={{ fontFamily: DISPLAY, fontSize: 20, color: T.gold }}>{s.nom}</div>
                <div style={{ fontFamily: MONO, fontSize: 11, color: T.dim, letterSpacing: '0.1em' }}>{s.surnom}</div>
                {s.prescription && <span style={{ fontFamily: MONO, fontSize: 10, color: '#C05050', letterSpacing: '0.15em', padding: '3px 8px', border: '1px solid #C0505060', background: 'rgba(192,80,80,0.08)' }}>PRESCRIPTION OBLIGATOIRE</span>}
              </div>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 0, padding: '0 18px 14px' }}>
                <div>
                  <div style={{ fontFamily: MONO, fontSize: 10, color: SC_LIGHT, letterSpacing: '0.2em', marginBottom: 6 }}>VERTUS</div>
                ...
                <div>
                  ...
                  {s.danger && (
                    <div style={{ marginTop: 8, padding: '8px 12px', background: 'rgba(192,48,48,0.08)', border: '1px solid rgba(192,48,48,0.30)', borderLeft: '3px solid #C03030' }}>
                      <div style={{ fontFamily: MONO, fontSize: 10, color: '#C03030', letterSpacing: '0.2em', marginBottom: 4 }}>⚠ DANGER</div>
          ...
          {ANESTHESIQUES_SED.map(a => (
            <div key={a.nom} style={{ marginBottom: 14, background: T.paper, border: `1px solid ${a.col}40`, borderLeft: `4px solid ${a.col}` }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 14, padding: '14px 18px 10px', flexWrap: 'wrap' }}>
                ...
                <span style={{ fontFamily: MONO, fontSize: 10, color: '#C05050', letterSpacing: '0.15em', padding: '3px 8px', border: '1px solid #C0505060', background: 'rgba(192,80,80,0.08)' }}>PRESCRIPTION OBLIGATOIRE</span>
              </div>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 0, padding: '0 18px 14px' }}>
                <div>
                ...
                <div>
                  <div style={{ padding: '8px 12px', background: 'rgba(192,48,48,0.08)', border: '1px solid rgba(192,48,48,0.30)', borderLeft: '3px solid #C03030' }}>
                    <div style={{ fontFamily: MONO, fontSize: 10, color: '#C03030', letterSpacing: '0.2em', marginBottom: 4 }}>⚠ DANGER</div>
              ...
              <tbody>
                {(ECHELLE_SED as unknown as string[][]).map((row, i) => (
                  <tr key={row[0]} style={{ background: i % 2 === 0 ? 'transparent' : `${SC}08` }}>
                    ...
                    <td style={{ padding: '9px 14px', fontFamily: BODY, fontSize: 14, color: '#C8C8D8', borderBottom: `1px solid ${SC}20` }}>{row[1]}</td>
                    <td style={{ padding: '9px 14px', fontFamily: BODY, fontSize: 14, color: '#C8C8D8', borderBottom: `1px solid ${SC}20` }}>{row[2]}</td>
                    <td style={{ padding: '9px 14px', fontFamily: BODY, fontSize: 14, color: '#C8C8D8', borderBottom: `1px solid ${SC}20` }}>{row[3]}</td>
          ...
          <div style={{ marginBottom: 20, padding: '18px 22px', background: 'rgba(192,48,48,0.06)', border: '1px solid rgba(192,48,48,0.25)', borderLeft: '4px solid #C03030' }}>
      ...
      {version === 'complete' && (
        <div>
          ...
          {obBlock(<>
            ...
            <RegBlock col="rgba(200,168,80,0.40)">
          ...
          {ob2Block(<>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              {[
                ...
                <div key={c.label} style={{ background: c.urgent ? 'rgba(140,30,30,0.06)' : `${OBC2}06`, border: `1px solid ${c.urgent ? 'rgba(180,60,60,0.40)' : OBC2 + '30'}`, borderLeft: `4px solid ${c.urgent ? '#B83030' : OBC2}`, padding: '16px 20px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 8 }}>
                    {c.urgent && <span style={{ fontFamily: MONO, fontSize: 10, color: '#C05050', background: 'rgba(180,60,60,0.12)', padding: '2px 7px', letterSpacing: '0.12em' }}>URGENCE</span>}
                    <div style={{ fontFamily: DISPLAY, fontSize: 17, color: c.urgent ? '#C05050' : OBC2_LIGHT }}>{c.label}</div>
                  </div>
          ...
          {ob2Block(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
              ...
              <div style={{ background: T.card, border: `1px solid rgba(80,140,80,0.35)`, padding: '16px 20px' }}>
                <div style={{ fontFamily: DISPLAY, fontSize: 16, color: '#70A870', marginBottom: 10 }}>Préparations végétales</div>
          ...
          {ob2Block(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginTop: 12 }}>
              ...
              <div style={{ background: 'rgba(160,60,60,0.06)', border: '1px solid rgba(180,60,60,0.35)', borderLeft: '3px solid rgba(180,60,60,0.70)', padding: '16px 20px' }}>
                <div style={{ fontFamily: DISPLAY, fontSize: 15, color: '#C06060', marginBottom: 8 }}>Appel immédiat d'un médecin si</div>
        ...
        <div>
          ...
          {ob2Block(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
              ...
              <div>
                <div style={{ fontFamily: DISPLAY, fontSize: 15, color: '#70A870', marginBottom: 8 }}>Végétaux</div>
          ...
          {ob2Block(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
              ...
              <div>
                <div style={{ fontFamily: DISPLAY, fontSize: 14, color: '#C06060', marginBottom: 8 }}>Appel médecin si</div>
      ...
      {version === 'complete' && (
        <div>
          ...
          {ob3Block(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginTop: 14 }}>
              <div style={{ background: 'rgba(140,30,30,0.06)', border: '1px solid rgba(180,60,60,0.40)', borderLeft: '4px solid rgba(180,60,60,0.70)', padding: '16px 20px' }}>
                <div style={{ fontFamily: DISPLAY, fontSize: 16, color: '#C05050', marginBottom: 10 }}>Chez la mère</div>
              ...
              <div style={{ background: 'rgba(140,30,30,0.06)', border: '1px solid rgba(180,60,60,0.40)', borderLeft: '4px solid rgba(180,60,60,0.70)', padding: '16px 20px' }}>
                <div style={{ fontFamily: DISPLAY, fontSize: 16, color: '#C05050', marginBottom: 10 }}>Chez le nouveau-né</div>
          ...
          {ob3Block(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 14 }}>
              <div style={{ background: T.card, border: `1px solid rgba(80,140,80,0.35)`, padding: '16px 20px' }}>
                <div style={{ fontFamily: DISPLAY, fontSize: 15, color: '#70A870', marginBottom: 10 }}>Préparations végétales</div>
              ...
              <div style={{ background: T.card, border: `1px solid rgba(200,168,80,0.35)`, padding: '16px 20px' }}>
      ...
      {version === 'resume' && (
        <div>
          ...
          {ob3Block(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
              <div style={{ background: 'rgba(140,30,30,0.06)', border: '1px solid rgba(180,60,60,0.35)', borderLeft: '3px solid rgba(180,60,60,0.70)', padding: '14px 16px' }}>
                <div style={{ fontFamily: DISPLAY, fontSize: 14, color: '#C05050', marginBottom: 8 }}>Chez la mère</div>
                <RegList items={['Hémorragie.', 'Fièvre puerpérale.', 'Infection.', 'Abcès mammaire.', 'Rétention placentaire.', 'Épuisement.']} />
              </div>
              <div style={{ background: 'rgba(140,30,30,0.06)', border: '1px solid rgba(180,60,60,0.35)', borderLeft: '3px solid rgba(180,60,60,0.70)', padding: '14px 16px' }}>
                <div style={{ fontFamily: DISPLAY, fontSize: 14, color: '#C05050', marginBottom: 8 }}>Chez le nouveau-né</div>
          ...
          {ob3Block(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 10 }}>
              {[
                { label: 'Végétaux', col: '#70A870', items: ['Camomille.', 'Mélisse.', 'Tilleul.', 'Lavande.', 'Plantain.', 'Consoude.'] },
        ...
        <div>
          ...
          {tpBlock(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(180px, 1fr))', gap: 8, marginTop: 12 }}>
              {['Infection.', 'Suppuration.', 'Gangrène.', 'Hémorragie.', 'Retard de consolidation.', 'Mauvaise position de l\'os.'].map(c => (
                <div key={c} style={{ background: 'rgba(140,30,30,0.06)', border: '1px solid rgba(180,60,60,0.35)', padding: '10px 12px', fontFamily: BODY, fontSize: 13, color: T.text, display: 'flex', alignItems: 'center', gap: 8 }}>
                  <span style={{ color: '#C05050', fontSize: 10 }}>◆</span>{c}
                </div>
              ))}
            </div>
            <RegBlock col="rgba(180,60,60,0.50)">
          ...
          {tpBlock(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 14, marginTop: 14 }}>
              ...
              <div style={{ background: T.card, border: 'rgba(200,168,80,0.35) solid 1px', padding: '16px 20px' }}>
      ...
      {version === 'resume' && (
        <div>
          ...
          {tpBlock(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 10 }}>
              {[
                { label: 'Végétaux', col: '#70A870', items: ['Consoude.', 'Prêle.', 'Ortie.', 'Plantain.', 'Romarin.', 'Lavande.', 'Sauge.', 'Calendula.', 'Échinacée.'] },
  ...
  return (
    <div style={{ marginTop: 50 }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: 30, padding: '36px 20px', background: T.card, border: `1px solid ${TRU}50`, position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ fontFamily: MONO, fontSize: 11, color: T.dim, letterSpacing: '0.12em', marginBottom: 14 }}>DISPENSAIRES DE EAST WELLSTER'S ET DE WEST ELIZABETH · 1890</div>
                ...
                <div key={t.label} style={{ background: T.card, border: `1px solid ${t.col}40`, borderLeft: `4px solid ${t.col}`, padding: '16px 20px' }}>
                  ...
                  {t.plantes && (
                    <div style={{ marginTop: 10 }}>
                      <div style={{ fontFamily: MONO, fontSize: 11, color: '#70A870', letterSpacing: '0.12em', marginBottom: 6 }}>PRÉPARATIONS VÉGÉTALES</div>
      ...
      {version === 'resume' && (
        <div>
          ...
          {truBlock(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 10 }}>
              {[
                { label: 'Végétaux', col: '#70A870', items: ['Consoude.', 'Prêle.', 'Plantain.', 'Lavande.', 'Romarin.', 'Sauge.', 'Calendula.', 'Échinacée.'] },
        ...
        <div>
          ...
          {zonBlock(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 14, marginBottom: 16 }}>
              ...
              <div style={{ background: 'rgba(140,30,30,0.06)', border: '1px solid rgba(180,60,60,0.30)', padding: '14px 16px' }}>
                <div style={{ fontFamily: MONO, fontSize: 11, color: '#C05050', letterSpacing: '0.14em', marginBottom: 8 }}>CHEZ L'HOMME</div>
                <RegList items={['Douleur autour de la morsure.', 'Fièvre.', 'Anxiété.', 'Difficultés à avaler.', 'Spasmes de la gorge.', 'Agitation croissante.']} />
              </div>
            </div>
            <RegBlock col="rgba(180,60,60,0.50)">
              <div style={{ fontFamily: MONO, fontSize: 11, color: '#C05050', letterSpacing: '0.14em', marginBottom: 8 }}>URGENCE — CONDUITE À TENIR</div>
          ...
          {zonBlock(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
              <div style={{ background: `${ZON}08`, border: `1px solid ${ZON}35`, borderTop: `2px solid ${ZON}`, padding: '16px 20px' }}>
                ...
                <div style={{ fontFamily: MONO, fontSize: 10, color: '#70A870', letterSpacing: '0.12em', margin: '10px 0 6px' }}>PLANTES</div>
          ...
          {zonBlock(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(220px, 1fr))', gap: 12 }}>
              {[
                { label: 'Rouget du porc', col: '#C05050', transmission: 'Manipulation de viande infectée.', signes: ['Rougeur de la peau.', 'Fièvre.', 'Douleur.'], traitement: 'Nettoyage, antisepsie, surveillance.' },
          ...
          {zonBlock(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 14 }}>
              ...
              <div style={{ background: T.card, border: 'rgba(80,140,80,0.35) solid 1px', padding: '16px 20px' }}>
                <div style={{ fontFamily: DISPLAY, fontSize: 15, color: '#70A870', marginBottom: 10 }}>Plantes médicinales</div>
        ...
        <div>
          {zonBlock(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(160px, 1fr))', gap: 8 }}>
              {[
                { label: 'Rage', col: '#C05050', note: 'Morsure animale — urgence.' },
                ...
                { label: 'Rouget du porc', col: '#C05050', note: 'Viande infectée.' },
          ...
          {zonBlock(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginTop: 12 }}>
              ...
              <div>
                <div style={{ fontFamily: DISPLAY, fontSize: 14, color: '#C05050', marginBottom: 8 }}>Signes chez l'homme</div>
          ...
          {zonBlock(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: 10 }}>
              {[
                { label: 'Rouget du porc', col: '#C05050', note: 'Rougeurs, fièvre, douleurs. Antisepsie.' },
          ...
          {zonBlock(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 10 }}>
              {[
                ...
                { label: 'Plantes', col: '#70A870', items: ['Thym.', 'Romarin.', 'Plantain.', 'Lavande.', 'Calendula.', 'Échinacée.', 'Ortie.', 'Consoude (réparation).'] },
              ].map(g => (
...
function ChirurgieTraumaDocument() {
  ...
  const urgBox = (children: React.ReactNode) => (
    <div style={{ background: 'rgba(180,40,40,0.08)', border: '1px solid rgba(180,40,40,0.35)', borderLeft: '4px solid #C04040', padding: '12px 16px', marginTop: 10 }}>
      {children}
    </div>
  );
        ...
        <div>
          ...
          {ctrBlock(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(190px, 1fr))', gap: 10 }}>
              {[
                { num: 'I', label: 'Observer avant d\'agir', col: '#5888A8', items: ['Origine du traumatisme.', 'Profondeur de la plaie.', 'Importance du saignement.', 'Présence d\'un projectile.', 'Atteinte d\'un os, tendon ou organe.'] },
                { num: 'II', label: 'Sauver la vie avant le membre', col: '#C04040', items: ['Comprimer la plaie.', 'Élever le membre si possible.', 'Appliquer un bandage compressif.'] },
          ...
          {ctrBlock(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 10 }}>
              {[
                ...
                { label: 'Saignement', col: '#C04040', items: ['Faible.', 'Modéré.', 'Abondant.'] },
                { label: 'Contamination', col: '#907030', items: ['Terre.', 'Vêtements.', 'Bois.', 'Plomb.', 'Poudre.', 'Fragments osseux.'] },
                { label: 'Lésions associées', col: '#5888A8', items: ['Fracture.', 'Luxation.', 'Atteinte tendineuse.', 'Lésion nerveuse.', 'Atteinte vasculaire.'] },
              ].map(s => (
          ...
          {ctrBlock(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-sit, minmax(190px, 1fr))', gap: 10 }}>
              {[
                { label: 'Mains du chirurgien', col: '#5888A8', items: ['Lavage au savon et eau chaude.', 'Brossage soigneux.', 'Désinfection à l\'alcool ou Acide phénique.'] },
          ...
          {ctrBlock(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(160px, 1fr))', gap: 8 }}>
              {[
                ...
                { label: 'Profondes', col: '#5888A8', note: 'Atteignent les muscles ou les tendons.' },
                ...
                { label: 'Infectées', col: '#C05050', note: 'Rougeur, douleur, suppuration, fièvre.' },
          ...
          {ctrBlock(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
              ...
              <div>
                <div style={{ fontFamily: DISPLAY, fontSize: 14, color: '#70A870', marginBottom: 8 }}>Plantes médicinales</div>
          ...
          {ctrBlock(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 12 }}>
              <div style={{ background: 'rgba(180,40,40,0.08)', border: '1px solid rgba(180,40,40,0.35)', borderLeft: '4px solid #C04040', padding: '14px 16px' }}>
                <div style={{ fontFamily: DISPLAY, fontSize: 15, color: '#C04040', marginBottom: 8 }}>Signes d'alerte</div>
              ...
              <div>
                ...
                <div style={{ background: `${CTR}08`, border: `1px solid ${CTR_LIGHT}30`, padding: '12px 14px' }}>
                  ...
                  <div style={{ fontFamily: DISPLAY, fontSize: 13, color: T.gold, fontStyle: 'italic', marginTop: 8, padding: '6px 10px', background: 'rgba(200,168,80,0.08)', border: '1px solid rgba(200,168,80,0.25)' }}>« Là où le pus s'accumule, il faut lui ouvrir un chemin. »</div>
                </div>
              </div>
            </div>
          </>)}
          ...
          {ctrBlock(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(160px, 1fr))', gap: 8, marginTop: 12 }}>
              {[
                { plant: 'Thym', col: '#70A870', usage: 'Lavage antiseptique, compresses.' },
          ...
          {ctrBlock(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
              <div style={{ background: 'rgba(140,10,10,0.08)', border: '1px solid rgba(140,10,10,0.35)', borderLeft: '4px solid #8A1010', padding: '14px 16px' }}>
                <div style={{ fontFamily: DISPLAY, fontSize: 15, color: '#C04040', marginBottom: 8 }}>Signes</div>
          ...
          {ctrBlock(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-sit, minmax(200px, 1fr))', gap: 12 }}>
              {[
                { label: 'Hémorragie secondaire', col: '#C04040', items: ['Comprimer immédiatement.', 'Rechercher le vaisseau responsable.', 'Nouvelle ligature si nécessaire.'] },
          ...
          {ctrBlock(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-sit, minmax(190px, 1fr))', gap: 12 }}>
              ...
              <div style={{ background: `${CTR}08`, border: `1px solid ${CTR_LIGHT}30`, padding: '14px 16px' }}>
                ...
                <div style={{ fontFamily: DISPLAY, fontSize: 14, color: '#70A870', marginBottom: 8, marginTop: 8 }}>Plantes</div>
      ...
      {version === 'resume' && (
        <div>
          ...
          {ctrBlock(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: 8 }}>
              {[
                { label: 'I — Observer avant d\'agir', col: '#5888A8' },
                { label: 'II — Sauver la vie avant le membre', col: '#C04040' },
              ...
              <div>
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6, marginBottom: 10 }}>
                  {['Rougeur', 'Gonflement', 'Chaleur', 'Douleur', 'Pus', 'Odeur', 'Fièvre'].map(s => (
                    <div key={s} style={{ background: 'rgba(180,40,40,0.08)', border: '1px solid rgba(180,40,40,0.30)', padding: '4px 10px', fontFamily: MONO, fontSize: 11, color: '#C04040' }}>⚠ {s}</div>
                  ))}
                </div>
          ...
          {ctrBlock(<>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
              ...
              <div>
                ...
                {[
                  { label: 'Hémorragie secondaire', col: '#C04040' },
          ...
          {ctrBlock(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 10 }}>
              {[
                ...
                { label: 'Végétaux', col: '#70A870', items: ['Calendula.', 'Plantain.', 'Consoude.', 'Lavande.', 'Romarin.', 'Échinacée.'] },
        ...
        <div>
          ...
          {dsiBlock(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 10, marginBottom: 12 }}>
              {dsiMethod('Eau bouillante', '#5888A8', (
                <>
          ...
          {dsiBlock(<>
            ...
            <div style={{ marginTop: 12, padding: '10px 14px', background: `rgba(180,60,40,0.08)`, border: `1px solid rgba(180,60,40,0.30)` }}>
              <span style={{ fontFamily: BODY, fontSize: 13, color: '#C05050' }}>Les mains ne doivent plus toucher de surface souillée avant l'intervention.</span>
            </div>
          </>)}
          ...
          {dsiBlock(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 12, marginBottom: 14 }}>
              ...
              <div style={{ background: T.card, border: 'rgba(200,168,80,0.35) solid 1px', padding: '14px 16px' }}>
          ...
          {dsiBlock(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 12 }}>
              {[
                { label: 'Avant l\'intervention', col: '#5888A8', items: ['Instruments stérilisés.', 'Mains désinfectées.', 'Peau préparée.', 'Pansements prêts.'] },
          ...
          {dsiBlock(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 12 }}>
              {[
                ...
                { label: 'Gangrène', col: '#C04040', items: ['Retrait des tissus morts.', 'Amputation si extension importante menaçant la vie du malade.'] },
              ].map(p => (
          ...
          {dsiBlock(<>
            ...
            <div style={{ marginTop: 12, padding: '10px 14px', background: `rgba(180,60,40,0.08)`, border: `1px solid rgba(180,60,40,0.30)` }}>
              <span style={{ fontFamily: BODY, fontSize: 13, color: '#C05050' }}>Toute aggravation impose une nouvelle désinfection et un examen complet.</span>
            </div>
          </>)}
        ...
        <div>
          ...
          {dsiBlock(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 10, marginBottom: 12 }}>
              {[
                { label: 'Eau bouillante', col: '#5888A8', content: ['Ébullition 20 à 30 minutes.', 'Méthode de référence.'] },
          ...
          {dsiBlock(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 10 }}>
              {[
                { label: 'Avant', col: '#5888A8', items: ['Instruments stérilisés.', 'Mains désinfectées.', 'Peau préparée.', 'Pansements prêts.'] },
          ...
          {dsiBlock(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-sit, minmax(180px, 1fr))', gap: 10 }}>
              {[
                ...
                { label: 'Gangrène', col: '#C04040', items: ['Retrait des tissus morts.', 'Amputation si menace vitale.'] },
              ].map(p => (
        ...
        <div>
          ...
          {fieBlock(<>
            ...
            <div style={{ background: T.card, border: 'rgba(80,140,80,0.35) solid 1px', padding: '14px 16px' }}>
              <div style={{ fontFamily: DISPLAY, fontSize: 14, color: '#70A870', marginBottom: 8 }}>Préparations végétales</div>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(120px, 1fr))', gap: 4 }}>
                {['Camomille.', 'Menthe.', 'Sauge.', 'Guimauve.', 'Thym.', 'Achillée.', 'Romarin.', 'Lavande.', 'Gentiane.', 'Saule blanc.'].map(p => (
                  <div key={p} style={{ fontFamily: BODY, fontSize: 13, color: T.text, padding: '3px 0', display: 'flex', alignItems: 'center', gap: 6 }}>
                    <span style={{ color: '#70A870', fontSize: 9 }}>◆</span>{p}
                  </div>
                ))}
              </div>
            </div>
        ...
        <div>
          ...
          {fieBlock(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 12 }}>
              ...
              <div>
                <div style={{ fontFamily: DISPLAY, fontSize: 14, color: '#70A870', marginBottom: 8 }}>Plantes</div>
          ...
          {fieBlock(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 10 }}>
              {[
                ...
                { label: 'Végétaux', col: '#70A870', items: ['Achillée.', 'Camomille.', 'Menthe.', 'Sauge.', 'Guimauve.', 'Thym.', 'Romarin.', 'Lavande.', 'Gentiane.', 'Saule blanc.'] },
              ].map(g => (
      ...
      {version === 'complete' && (
        <div>
          ...
          {micBlock(<>
            ...
            <RegBlock col="rgba(180,60,60,0.50)">
              <div style={{ fontFamily: MONO, fontSize: 11, color: '#C05050', letterSpacing: '0.14em', marginBottom: 8 }}>COMPLICATIONS À SURVEILLER</div>
          ...
          {micBlock(<>
            ...
            <RegBlock col="rgba(180,60,60,0.50)">
              <div style={{ fontFamily: MONO, fontSize: 11, color: '#C05050', letterSpacing: '0.14em', marginBottom: 8 }}>COMPLICATIONS</div>
      ...
      {version === 'resume' && (
        <div>
          {micBlock(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(160px, 1fr))', gap: 8 }}>
              {[
                { label: 'Rougeole', col: '#C05050', note: 'Virale, éruption rouge, très contagieuse.' },
          ...
          {micBlock(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 12 }}>
              <div>
                <div style={{ fontFamily: DISPLAY, fontSize: 14, color: '#C05050', marginBottom: 8 }}>Signes</div>
          ...
          {micBlock(<>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-sit, minmax(180px, 1fr))', gap: 10 }}>
              {[
                ...
                { label: 'Désinfectants', col: T.gold, items: ['Acide phénique.', 'Teinture d\'iode.'] },
                { label: 'Végétaux', col: '#70A870', items: ['Camomille.', 'Tilleul.', 'Mauve.', 'Guimauve.', 'Sauge.', 'Thym.', 'Menthe.', 'Lavande.', 'Romarin.', 'Violette.', 'Primevère.'] },
              ].map(g => (
      ...
      {version === 'complete' && (
        <div>
          ...
          {tbcBlock(<>
            ...
            <RegBlock col={`rgba(180,40,40,0.40)`}>
...
const BOOK_DEFAULT = { bg: 'linear-gradient(160deg,#160c08,#0e0804 55%,#120a06)', spine: '#3a2010', border: '#221408' };
  ...
  return (
    <div
      ...
      style={{
        ...
        cursor: 'pointer',
        boxShadow: selected ? `0 0 0 1px ${T.gold}, 0 4px 16px rgba(200,168,80,0.18)` : '1px 2px 6px rgba(0,0,0,0.7)',
        userSelect: 'none',
      }}
    >
      ...
      <div style={{ width: '100%', padding: '8px 10px', background: 'linear-gradient(168deg,#7a5414,#4e3208 30%,#6a4810 55%,#3e2608 75%,#5a3e0e 100%)', border: '1.5px solid #8a5e18', position: 'relative', textAlign: 'center', boxShadow: 'inset 0 2px 4px rgba(220,170,65,0.28),inset 0 -2px 4px rgba(0,0,0,0.6),0 2px 5px rgba(0,0,0,0.6)' }}>
        ...
        <div style={{ position: 'absolute', top: 3,    left:  3, width: 5, height: 5, borderRadius: '50%', background: 'radial-gradient(circle at 35% 30%,#c09020,#6a4208)', boxShadow: '0 1px 2px rgba(0,0,0,0.6)' }} />
        <div style={{ position: 'absolute', top: 3,    right: 3, width: 5, height: 5, borderRadius: '50%', background: 'radial-gradient(circle at 35% 30%,#c09020,#6a4208)', boxShadow: '0 1px 2px rgba(0,0,0,0.6)' }} />
        <div style={{ position: 'absolute', bottom: 3, left:  3, width: 5, height: 5, borderRadius: '50%', background: 'radial-gradient(circle at 35% 30%,#c09020,#6a4208)', boxShadow: '0 1px 2px rgba(0,0,0,0.6)' }} />
        <div style={{ position: 'absolute', bottom: 3, right: 3, width: 5, height: 5, borderRadius: '50%', background: 'radial-gradient(circle at 35% 30%,#c09020,#6a4208)', boxShadow: '0 1px 2px rgba(0,0,0,0.6)' }} />
        <span style={{ display: 'block', fontSize: 12, color: '#9a7828', marginBottom: 3, position: 'relative', zIndex: 1 }}>{icon}</span>
        <span style={{ display: 'block', fontFamily: DISPLAY, fontSize: 11, color: '#C8A850', lineHeight: 1.55, textShadow: '0 1px 2px rgba(0,0,0,0.8)', position: 'relative', zIndex: 1 }}>{t1}</span>
        {t2 && <span style={{ display: 'block', fontFamily: DISPLAY, fontSize: 11, color: '#C8A850', lineHeight: 1.55, textShadow: '0 1px 2px rgba(0,0,0,0.8)', position: 'relative', zIndex: 1 }}>{t2}</span>}
      </div>
    </div>
  );
}
  ...
  return (
    <div>
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '9px 0 4px' }}>
        ...
        <span style={{ fontFamily: MONO, fontSize: 10, color: '#C8A850', fontStyle: 'italic', letterSpacing: '0.2em', border: '1px solid rgba(20,50,110,0.6)', background: 'linear-gradient(135deg, #04080e, #02050a)', padding: '3px 16px 4px', whiteSpace: 'nowrap', flexShrink: 0, boxShadow: 'inset 0 1px 0 rgba(200,168,80,0.06)' }}>✦ {label} ✦</span>
      ...
      <div style={{ height: 14, background: 'linear-gradient(to bottom, #060c18, #040910 18%, #030810 50%, #020508 100%)', borderTop: '2px solid rgba(20,50,110,0.6)', margin: '0 -14px', boxShadow: '0 5px 14px rgba(0,0,0,0.9)' }} />
    </div>
  );
}
...
function BiblioEtageres({
  ...
  return (
    <div style={{ background: 'linear-gradient(to bottom,#03070e,#02050a 35%,#04060c 70%,#020408)', border: '10px solid #060c16', borderRadius: 4, overflow: 'hidden', marginBottom: 20, boxShadow: '0 0 0 1px #020408,0 24px 60px rgba(0,0,0,0.98),inset 0 2px 0 rgba(200,168,80,0.04),inset 0 -3px 0 rgba(0,0,0,0.7)' }}>
      ...
      <div style={{ padding: '12px 24px 10px', background: 'linear-gradient(to bottom, #03070e, #02050a)' }}>
        <div style={{ border: '2px solid #122040', background: 'linear-gradient(165deg,#060e1a,#03090e 45%,#050c14 70%,#030710)', padding: '20px 80px 18px', textAlign: 'center', position: 'relative', margin: '0 auto', boxShadow: 'inset 0 1px 0 rgba(200,168,80,0.07),0 4px 16px rgba(0,0,0,0.9)' }}>
      ...
      <div style={{ padding: '4px 14px 10px', background: 'linear-gradient(to bottom, #03070e, #02050a)' }}>
        ...
        <ShelfRow label="Vos Documents">
          ...
          {creatingCat ? (
            <div style={{ width: 200, background: '#1a0e06', border: `1px solid ${T.gold}`, borderRadius: 2, padding: '14px 12px', display: 'flex', flexDirection: 'column', gap: 8, flexShrink: 0 }}>
              <div>
  ...
  return (
    <div style={{ fontFamily: BODY }}>
      <style>{`
        ...
        .bib-book:hover { transform: scale(1.05) translateY(-5px) !important; box-shadow: 0 10px 24px rgba(0,0,0,0.85), 0 3px 8px rgba(0,0,0,0.5) !important; position: relative; z-index: 3; }
      `}</style>
      ...
      {openCat && openCat.id !== 'reglement-interne' && openCat.id !== 'serment-hippocrate' && openCat.id !== 'guide-herboriste' && openCat.id !== 'specialites-proposees' && openCat.id !== 'protocole-sanitaire' && openCat.id !== 'protocole-epidemie' && openCat.id !== 'doctrine-purete' && openCat.id !== 'botanique-medicale' && openCat.id !== 'manuel-infirmiers' && openCat.id !== 'doctrine-cataplasmes' && openCat.id !== 'manuel-medecin' && openCat.id !== 'medecine-generale' && openCat.id !== 'theorie-germes' && openCat.id !== 'pharmacie-antidouleurs' && openCat.id !== 'pharmacie-sedatifs' && openCat.id !== 'chirurgie-suture' && openCat.id !== 'obstetrique-i' && openCat.id !== 'obstetrique-ii' && openCat.id !== 'obstetrique-iii' && openCat.id !== 'traitement-physio' && openCat.id !== 'traumatologie' && openCat.id !== 'guide-zoonoses' && openCat.id !== 'maladies-infantiles' && openCat.id !== 'fievres-communes' && openCat.id !== 'tuberculose' && openCat.id !== 'desinfection-steri' && openCat.id !== 'chirurgie-trauma' && (
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 24, flexWrap: 'wrap' }}>
            <div style={{ width: 50, height: 50, background: 'rgba(200,168,80,0.08)', border: `1px solid ${T.border}`, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 24, flexShrink: 0 }}>{openCat.icon}</div>
