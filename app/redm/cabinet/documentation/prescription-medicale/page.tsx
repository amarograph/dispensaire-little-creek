    ...
    <div style={{ fontFamily: BODY }}>
      ...
      <div ref={printRef} className="print-area" style={{ background: '#183746', border: '2px solid #C8BEA5', padding: '52px 60px', width: 794, maxWidth: 794, margin: '0 auto', color: '#102B3B', fontFamily: "'Libre Baskerville', 'Courier New', monospace" }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 36 }}>
          ...
          <div style={{ fontSize: 14, color: '#6A5030', marginTop: 6 }}>Prescription médicale</div>
        </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                  ...
                  {selectedPat
                    ? <div style={{ background: COL + '08', border: `1px solid ${COL}30`, padding: '18px 22px', height: '100%', boxSizing: 'border-box' }}>
                        ...
                        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
                          ...
                          <span style={{ fontFamily: MONO, fontSize: 14, color: COL, background: COL + '15', padding: '3px 10px', border: `1px solid ${COL}40` }}>{selectedPat.type}</span>
                          <span style={{ fontFamily: MONO, fontSize: 14, color: T.dim, background: 'rgba(255,255,255,0.04)', padding: '3px 10px', border: `1px solid ${T.border}` }}>Dossier ouvert le {selectedPat.dateConsult}</span>
                        </div>
        ...
        <section style={{ background: T.card, border: `1px solid ${T.border}`, borderTop: `3px solid ${T.gold}`, overflow: 'hidden' }}>
          ...
          <div style={{ padding: '20px 24px', display: 'grid', gridTemplateColumns: '1fr 200px', gap: 16 }}>
            ...
            <div>
              <label style={{ fontFamily: MONO, fontSize: 14, color: T.dim, letterSpacing: '0.12em', marginBottom: 6, display: 'block' }}>DATE</label>
        ...
        <section style={{ background: T.card, border: `1px solid ${T.border}`, borderTop: `3px solid ${T.muted}`, overflow: 'hidden' }}>
          <div style={{ padding: '16px 24px', borderBottom: `1px solid ${T.border}`, background: 'rgba(139,115,85,0.08)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <span style={{ fontFamily: MONO, fontSize: 14, color: T.muted, letterSpacing: '0.16em' }}>CONTENU DE LA PRESCRIPTION</span>
