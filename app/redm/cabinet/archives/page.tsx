    ...
    <div style={{ fontFamily: "'Josefin Slab', Georgia, serif" }}>
      ...
      <div style={{ marginBottom: 36 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 18 }}>
          ...
          <span style={{ fontFamily: MONO, fontSize: 14, color: '#C8A850', letterSpacing: '0.18em' }}>CABINET THÉRAPEUTIQUE · ARCHIVES</span>
        </div>
        ...
        {MODULES.map(m => {
          ...
          return (
            <div key={m.id}
              ...
              <div style={{ fontFamily: "'Josefin Slab', Georgia, serif", fontSize: 17, color: '#5A4A35', lineHeight: 1.55 }}>{m.desc}</div>
