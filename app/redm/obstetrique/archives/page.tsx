...
const MODULES = [
  {
    id:    'cloturees',
    href:  '/redm/obstetrique/archives/cloturees',
    icon:  '📦',
    label: 'Archives Clôturées',
    sub:   'DOSSIERS STATUT ARCHIVÉ',
    desc:  'Patientes ayant terminé leur suivi. Dossiers clôturés, consultables et restaurables.',
    color: '#5A4A6A',
    badge: 'CLÔ',
  },
];

export default function ObstetriqueArchivesHubPage() {
    ...
    <div style={{ fontFamily: "'Cormorant Garamond', Georgia, serif" }}>
      ...
      <div style={{ marginBottom: 36 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 18 }}>
          ...
          <span style={{ fontFamily: MONO, fontSize: 14, color: '#D1B77C', letterSpacing: '0.18em' }}>OBSTÉTRIQUE · ARCHIVES</span>
        </div>
        ...
        <p style={{ fontFamily: MONO, fontSize: 14, color: '#C8BEA5', letterSpacing: '0.12em', marginTop: 8 }}>
          MÉMOIRE DE L&apos;OBSTÉTRIQUE · 1890 — SÉLECTIONNEZ UNE SECTION
        </p>
      </div>
