    ...
    <>
      <style>{`
        ...
        .redm-header {
          ...
          box-shadow: 0 2px 30px rgba(0,0,0,0.7), 0 1px 0 rgba(200,147,42,0.08);
        }
        ...
        .redm-logo-box {
          ...
          font-size: 18px;
          box-shadow: 0 0 14px rgba(139,58,26,0.4), inset 0 1px 0 rgba(200,147,42,0.2);
          clip-path: polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%);
        }
        .redm-logo-title {
          font-family: var(--r-serif); font-weight: 700; font-size: 13px;
          color: var(--r-ink); line-height: 1; letter-spacing: 0.06em;
        }
        .redm-logo-sub {
          font-family: var(--r-mono); font-size: 9px;
          color: var(--r-gold); letter-spacing: 0.18em; line-height: 1.3;
        ...
        .redm-nav a {
          font-family: var(--r-serif); font-weight: 400; font-size: 12px;
        ...
        /* ══════════════════════════════════════
           COMPOSANTS PARTAGÉS (utilisables dans les sous-pages)
        ══════════════════════════════════════ */
        ...
        .redm-card::before {
          ...
          background: linear-gradient(135deg, rgba(200,147,42,0.04) 0%, transparent 60%);
          pointer-events: none;
        }
        .redm-card:hover {
        ...
        .redm-section-title {
          font-family: var(--r-serif); font-size: 11px; font-weight: 700;
        ...
        .redm-label {
          display: block;
          font-family: var(--r-serif); font-size: 10px; font-weight: 600;
        ...
        .redm-ornament-divider span {
          font-family: var(--r-serif); font-size: 14px;
      ...
      <div className="redm-root">
        ...
        <svg className="redm-ornament" viewBox="0 0 500 500" fill="none" xmlns="http://www.w3.org/2000/svg">
          {/* Cercles concentriques style médaillon */}
          ...
          {/* Ornements aux 4 coins cardinaux */}
          {[0, 90, 180, 270].map((a, i) => {
            ...
            return (
              <g key={i}>
                <circle cx={cx} cy={cy} r="10" stroke="#C8932A" strokeWidth="1" fill="none"/>
                <circle cx={cx} cy={cy} r="4"  fill="#C8932A" fillOpacity="0.6"/>
              </g>
            );
          })}

          {/* Serpent d'Asclépios (stylisé) */}
        ...
        <header className="redm-header">
          <div className="redm-nav-inner">
            ...
            {/* Logo */}
            <Link href="/redm" style={{ display: 'flex', alignItems: 'center', gap: 10, textDecoration: 'none', flexShrink: 0 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexShrink: 0 }}>
              ...
              <Link href="/fivem" className="redm-fivem-btn">
                <span style={{ fontSize: 9 }}>◈</span> FiveM
              </Link>
        ...
        <footer className="redm-footer">
          <div className="redm-footer-inner">
            <span style={{ fontFamily: "'Courier Prime', monospace", fontSize: 10, color: '#4A3520', fontStyle: 'italic' }}>
              ✚ La Tanière de l'EMS — Dispensaire RedM
            </span>
            <span style={{ fontFamily: "'Courier Prime', monospace", fontSize: 10, color: '#4A3520', letterSpacing: '0.1em' }}>
              ANNO DOMINI MDCCCXC · MÉDECINE DU FAR WEST
            </span>
          </div>
        </footer>
      </div>
