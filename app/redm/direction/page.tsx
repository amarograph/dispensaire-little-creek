...
const MODULES = [
  ...
  { id: 'salaires',  href: '/redm/direction/salaires',  icon: '💰', label: 'Grille Salariale',      sub: 'SALAIRES PAR GRADE',             desc: "Définir le salaire hebdomadaire de chaque grade du dispensaire. Directeur, Médecin, Infirmier, Apprenti…",                  color: '#D1B77C', badge: 'SAL' },
