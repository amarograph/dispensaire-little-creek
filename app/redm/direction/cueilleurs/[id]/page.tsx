  ...
  return (
    <div style={{ fontFamily: BODY, maxWidth: 900, margin: '0 auto', padding: '32px 0 60px' }}>
      <style>{`
        ...
        .plant-row:hover { background: rgba(209,183,124,0.05) !important; }
      `}</style>
        ...
        {editProfil ? (
          <div>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14, marginBottom: 14 }}>
              <div>
                ...
                <input value={profilForm.nom_rp} onChange={e => setProfilForm(p => ({ ...p, nom_rp: e.target.value }))}
                  style={{ width: '100%', boxSizing: 'border-box', fontFamily: BODY, fontSize: 15, color: T.text, background: '#183746', border: `1px solid rgba(209,183,124,0.3)`, padding: '9px 12px', outline: 'none' }} />
              </div>
              <div>
            ...
            <div style={{ display: 'flex', gap: 8 }}>
              <button onClick={sauvegarderProfil} disabled={savingProfil} style={{ fontFamily: MONO, fontSize: 11, background: 'rgba(209,183,124,0.15)', border: `1px solid ${T.gold}`, color: T.gold, padding: '8px 20px', cursor: 'pointer', letterSpacing: '0.1em' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'flex-end', gap: 12, marginBottom: 28, flexWrap: 'wrap' }}>
            ...
            <div>
              ...
              <select
                ...
                style={{ fontFamily: MONO, fontSize: 15, color: T.text, background: '#183746', border: `1px solid rgba(209,183,124,0.4)`, padding: '10px 12px', outline: 'none', cursor: 'pointer', colorScheme: 'dark' }}
              >
            ...
            <div>
              ...
              <input
                ...
                style={{ width: 90, fontFamily: MONO, fontSize: 15, color: T.gold, background: '#183746', border: `1px solid rgba(209,183,124,0.4)`, padding: '10px 12px', outline: 'none', colorScheme: 'dark' }}
              />
            </div>
                ...
                {PLANTES.map(plante => {
                  ...
                  return (
                    <div key={plante} className="plant-row" style={{
                      ...
                      borderBottom: `1px solid rgba(180,160,113,0.14)`,
                      ...
                      <input
                        ...
                        style={{
                          ...
                          background: qty > 0 ? 'rgba(209,183,124,0.10)' : 'rgba(209,183,124,0.04)',
                          border: `1px solid ${qty > 0 ? 'rgba(209,183,124,0.35)' : 'rgba(209,183,124,0.15)'}`,
                ...
                <div>
                  ...
                  <input
                    ...
                    style={{
                      ...
                      background: 'rgba(209,183,124,0.06)', border: `1px solid rgba(209,183,124,0.35)`,
        ...
        <>
          ...
          {loadingArch ? (
            ...
            <div style={{ border: `1px solid ${T.border}`, borderRadius: 8, overflow: 'hidden' }}>
              <div style={{ display: 'grid', gridTemplateColumns: '140px 1fr 110px 120px 110px', background: 'rgba(209,183,124,0.06)', borderBottom: `1px solid ${T.border}`, padding: '10px 16px' }}>
                ...
                <div key={a.id}>
                  <div
                    ...
                    style={{
                      ...
                      borderBottom: i < archives.length - 1 && expandedArch !== a.id ? `1px solid rgba(180,160,113,0.18)` : 'none',
                      background: expandedArch === a.id ? 'rgba(209,183,124,0.04)' : 'transparent',
                    }}
                  >
                  ...
                  {expandedArch === a.id && (
                    <div style={{ padding: '0 16px 16px', borderBottom: `1px solid rgba(180,160,113,0.18)`, background: 'rgba(209,183,124,0.02)' }}>
