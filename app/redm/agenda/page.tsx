...
export default function AgendaDispensairePage() {
  ...
  async function saveToServer(newRdvs: RendezVous[]) {
    ...
    try {
      await fetch('/api/agenda-commun', {
        ...
        body: JSON.stringify(newRdvs.filter(r => r.source !== 'cabinet')),
      });
  ...
  return (
    <div style={{ fontFamily: BODY }}>
      <style>{`
        ...
        .rdv-badge.cabinet { cursor: default; }
        .rdv-badge.cabinet:hover { opacity: 1; }
      ...
      <div style={{ marginBottom: 24 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 14 }}>
          ...
          <span style={{ fontFamily: MONO, fontSize: 14, color: T.gold, letterSpacing: '0.16em' }}>DISPENSAIRE · AGENDA</span>
