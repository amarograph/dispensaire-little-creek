...
const templates = [
  { id: 'traumatologie', icon: '🦴', title: 'Traumatologie', desc: 'Accident, blessure, fracture' },
...
export default function FiveMReportsPage() {
  const router = useRouter();

  return (
    <div>
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-orange-400">Créer un rapport</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {templates.map((t) => (
          <button
            ...
            className="bg-slate-800/50 border border-slate-700 hover:border-orange-700 hover:bg-orange-950/30 rounded-xl p-5 transition group text-left"
          >
            <div className="text-3xl mb-3">{t.icon}</div>
            <h2 className="text-sm font-semibold text-orange-200 group-hover:text-orange-400 transition">
              {t.title}
            </h2>
